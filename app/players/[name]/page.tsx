        ...
        >
          ...
          <div className="relative px-6 pt-7 pb-6 flex flex-col items-center">
            ...
            <div
              ...
              style={{
                width: 92, height: 92, fontSize: 40,
                color: "#fff",
                background: `radial-gradient(120% 120% at 30% 20%, ${accent}, rgba(255,255,255,0.04))`,
                border: `3px solid ${accent}`,
                boxShadow: `0 0 30px ${accent}55, inset 0 2px 10px rgba(255,255,255,0.18)`,
              }}
            >
              {no !== "-" ? no : "?"}
            </div>
