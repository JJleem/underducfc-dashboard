    ...
    <div className="min-h-dvh bg-gray-50 dark:bg-[#09090b] text-gray-900 dark:text-zinc-100 font-sans max-w-md mx-auto relative shadow-2xl overflow-hidden transition-colors duration-300">
      ...
      <main className="p-5 pb-28">
        ...
        {nextMatch && dDay !== null && (() => {
          ...
          return (
            <section className="relative mb-5 rounded-[26px] bg-white p-4 text-gray-900 shadow-soft ring-1 ring-gray-200 dark:bg-[#10182f] dark:text-white dark:shadow-[0_16px_36px_rgba(15,23,42,0.22)] dark:ring-white/10">
              <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[26px] [transform:translateZ(0)]">
                <div className="absolute -right-10 -top-12 h-36 w-36 rounded-full bg-[#FF8FA3]/20 blur-3xl dark:bg-[#FF8FA3]/25" />
              </div>
          ...
          {lightbox && (
            ...
            >
              ...
              <PinchZoomImage
                ...
                alt="경기사진"
                className="p-[6vw]"
                imageClassName="max-h-[88vh] max-w-[88vw] rounded-xl"
              />
              {/* 다음 */}
      ...
      {showTopBtn && (
        ...
        <button
          ...
          className="fixed bottom-[calc(6rem+env(safe-area-inset-bottom))] right-6 z-50 w-10 h-10 rounded-full bg-white dark:bg-[#161618] border border-gray-200 dark:border-white/10 shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
          aria-label="맨 위로"
        >
