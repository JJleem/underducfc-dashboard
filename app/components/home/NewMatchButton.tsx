  ...
  return (
    <>
      <button
        ...
        className={
          variant === "header"
            ? "press-icon touch-target flex h-8 w-8 items-center justify-center rounded-full bg-[var(--ud-primary)] text-white shadow-sm active:opacity-70 dark:bg-[var(--ud-primary)]"
