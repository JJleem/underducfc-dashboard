...
// 감독 — 샴페인 골드 방패에 딥 로열 퍼플 에나멜.
// 검정+흰 광택은 라인업의 작은 크기에서 흰 부분만 남아 실버 등급처럼 읽혔다.
// 최상위 특별 칭호답게 골드를 주색으로 올리고, 원형 골드 등급과는 방패 실루엣으로 가른다.
const MANAGER_METAL: Metal = {
  ramp: ["#FFF8D8", "#FFE29A", "#E6AD38", "#815319", "#2A153D"],
  aura: true,
  foil: "#D8B4FE",
};
